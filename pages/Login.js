  ...
  return (
    <View style={styles.container}>
      <View style={styles.box}>
        <View>
          <Text style={[styles.login, styles.text]}>Login</Text>
        </View>
      ...
      <View style={styles.box2}>
        ...
        <View style={{flex:1,flexDirection:"row"}}>
          <Text style={[styles.text, styles.acountText]}>Don't have an account ?
          </Text>
          <TouchableOpacity onPress={()=>{props.navigation.navigate("Login")}}>
          <Text style={[styles.text, styles.acountText]}> Sign Up</Text>
          </TouchableOpacity>
        </View>
      </View>
